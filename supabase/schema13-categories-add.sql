-- Part 13: add two categories — live=הופעות חיות, exhibitions=תערוכות.
-- Run once in the Supabase SQL Editor. Supersedes the category lists in schema7.
-- Full set now: fringe, live, bohemia, exhibitions, festival, cinema, bars,
--               restaurants, club, secret, other.
...
begin
  ...
  if p_category not in ('fringe','live','bohemia','exhibitions','festival','cinema','bars','restaurants','club','secret','other') then
    return 'bad category';
  end if;
